...
TEST(test_list, correct_search_key)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, checkkey_false_when_key_isnot_in_list)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, correct_get_cur)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, correct_go_next)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, can_push_after_key)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, cant_push_after_key_when_key_isnot_in_list)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, correct_push_after_key)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, can_push_before_key)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, cant_push_before_key_when_key_isnot_in_list)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, correct_push_before_key)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, can_pop_after_key)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, can_pop_before_key)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, cant_pop_after_key_when_key_isnt_inlist)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, cant_pop_before_key_when_key_isnt_inlist)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, correct_pop_after_key)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, correct_pop_before_key)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, correct_push_after_curr)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, can_push_before_curr)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, correct_push_before_curr)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, can_pop_after_curr)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, can_pop_before_curr)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, correct_pop_after_curr)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
...
TEST(test_list, correct_pop_before_curr)
{
    List<int> a;
    a.PushBack(8, 4);
    a.PushBack(10, 5);
